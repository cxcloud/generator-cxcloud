...
export class OrdersController {
    ...
    @Security('token')
    @POST
    async createOrder(body: ICreateOrder, @Context ctx: ServiceContext): Promise<Order> {
    ...
    @Security('token')
    @GET
    getOrderById(@PathParam('id') orderId: string, @Context ctx: ServiceContext): Promise<Order> {
